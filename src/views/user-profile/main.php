...
<div class="modal" id="update-details-collection-success">
    <div class="text-white rounded-3xl p-6 w-80 text-center bg-dark-blue">
        <h1 class="mb-6 text-lg">¡Colección actualizada con éxito!</h1>
        <div class="flex justify-around">
            <button onclick="closeModal('update-details-collection-success')" class="bg-transparent border-white border-2 py-2 px-4 rounded-3xl hover:bg-white hover:text-black cancel">Hecho</button>
        </div>
    </div>
</div>
...
<div class="modal" id="change-password-success">
    <div class="text-white rounded-3xl p-6 w-80 text-center bg-dark-blue">
        <h1 class="mb-6 text-lg">¡Cambio de contraseña realizado con éxito!</h1>
        <div class="flex justify-around">
            <button onclick="closeModal('change-password-success')" class="bg-transparent border-white border-2 py-2 px-4 rounded-3xl hover:bg-white hover:text-black cancel">Hecho</button>
        </div>
    </div>
</div>
<div class="modal" id="change-password-fail">
    <div class="text-white rounded-3xl p-6 w-80 text-center bg-dark-blue">
        <h1 class="mb-6 text-lg">Los datos son erróneos o vacíos. Intente nuevamente</h1>
        <div class="flex justify-around">
            <button onclick="closeModal('change-password-fail')" class="bg-transparent border-white border-2 py-2 px-4 rounded-3xl hover:bg-white hover:text-black cancel">Hecho</button>
        </div>
    </div>
</div>
<div class="modal" id="var_error">
    <div class="text-white rounded-3xl p-6 w-80 text-center bg-dark-blue">
        <h1 class="mb-6 text-lg">¡Los datos que introdujo son erróneos! Revise los datos de verificación</h1>
        <div class="flex justify-around">
...
<div class="modal" id="delete-successful">
    <div class="text-white rounded-3xl p-6 w-80 text-center bg-dark-blue">
        <h1 class="mb-6 text-lg">¡Eliminación éxitosa!</h1>
        <div class="flex justify-around">
            <button onclick="closeModal('delete-successful')" class="bg-transparent border-white border-2 py-2 px-4 rounded-3xl hover:bg-white hover:text-black cancel">Hecho</button>
        </div>
    </div>
</div>
...
if(isset($_GET['success'])){
    ...
    switch ($proceso) {
        ...
        case 'cambio_contraseña_éxito':
            echo "<script>openModal('change-password-success');</script>";
            break;
        ...
        case 'eliminacion_exitosa':
            echo "<script>openModal('delete-successful');</script>";
            break;
